...
class TDNN(nn.Module):
    ...
    def forward(self, x, x_len=None):
        ...
        if x_len is None:
            ...
            return self.__masking(conv_out, x_len)
    ...
    def special_convolution(self, x, kernel, context, bias):
        ...
        xs = self.bias.data.new_zeros(batch_size, kernel.size()[0], len(valid_steps))
